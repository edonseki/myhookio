...
window.onbeforeunload = function(e) {
    browser.runtime.sendMessage({ function: "terminateTheExtension" }, (response) => {});
};
...
$(".requests_table").delegate('tr', 'click', function() {
    browser.runtime.sendMessage({ function: "requestDetails" , request_id : $(this).attr('row_id') }, (request) => {
...
$(".clear_button").click(function (){
    browser.runtime.sendMessage({ function: "clearRequestHistory" }, (response) => {
